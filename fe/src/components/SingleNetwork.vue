      ...
      <v-col cols="4" class="d-flex justify-center align-center">
        <div class="pa-2">
          ...
          <p>
            ...
            everyone in the country whether they are citizens or foreigners. The
...
export default {
  ...
  methods: {
    getMessage() {
      console.info('SingleNetwork getMessage');
    },
    generateArc() {
      const w = 500;
      const h = 500;
      ...
      const maxdp = d3.max(sortedGDP, (o) => o.value);
  ...
  mounted() {
    console.error('SingleNetwork mounted');
    this.bus.$on('submit', this.getMessage);
    this.generateArc();
    // this.$refs.cyRT.instance.layout({ name: 'dagre' }).run();
  },
};
</script>
